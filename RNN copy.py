...
class RNN:
    ...
    def bwd_pass(self, actual_batch_output, batch_x_inp):
        ...
        for t in range(self.batch_size-1, -1, -1):
            ...
            # 
        self.LSTM.update_weights(total_forgetg_diff/self.batch_size, total_inputg_diff/self.batch_size, total_actg_diff/self.batch_size, total_outputg_diff/self.batch_size)
            # 
